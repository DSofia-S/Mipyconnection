...
<head>
    ...
    <title>Registro MIPYME - Paso 1</title>
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('empresa.guardarPaso1') }}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="telefono" name="telefono" value="{{ old('telefono') }}" pattern="\d*" required title="Solo se permiten números">
            </div>
